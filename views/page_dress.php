<?php 
require("../controllers/page_dress_con.php");
?>
<html>
    <head>
    ...
    <body>
        ...
        <div>
            <p align="right" style="color : black ; font-family:Microsoft JhengHei;"><?php echo "您好阿  " . $sUserName . "  大大<br>" ?>
                ...
                <?php else: ?>
                    <span style="" valign="baseline"><a href="page_dress.php?logout=1">登出<br></a>
                <?php endif; ?>
            </p>
        </div>
        <div>
            <img class = "front_pic" src="img/dress_front.png">
            <br>
        ...
        <div id = "page_index">
            ...
            <a href = "article.php?ArticleID=<?php echo $row["uID"]?>">
                <div class="portfolio-box portfolio-box-container content_box">
                	...
                	<?php else: ?>
                	<img src="img/dress_front.png" style="width:300px">
                	<?php endif ?>
